...
// Versione cache: aggiorna questo numero quando rilasci una nuova versione
const CACHE_NAME   = 'annuario-v1.0';
const STATIC_CACHE = 'annuario-static-v1.0';
...
console.log('[SW] Service Worker caricato — Annuario Scolastico Emotivo v1.0');
